...
### TASK 5 (PERSON A) #########################################################
main : main.o pod.o accelerometer.o navigation.o bms.o
	$(CC) $(OBJS) $(LFLAGS) main.o -o main

main.o : main.cpp pod.h accelerometer.h navigation.h bms.h
	$(CC) $(CFLAGS) main.cpp
### END OF TASK 5 (PERSON A) ##################################################

pod.o : pod.cpp pod.h accelerometer.h navigation.h bms.h
	$(CC) $(CFLAGS) pod.cpp
